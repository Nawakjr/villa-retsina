        ...
        <table className="w-full border-collapse text-left text-sm">
          <thead>
            <tr className="bg-sable text-anthracite">
              <th className="px-4 py-3 font-medium">{labels.colSeason}</th>
              <th className="px-4 py-3 font-medium">{labels.colPeriod}</th>
              <th className="px-4 py-3 text-right font-medium">{labels.colRdc}</th>
              <th className="px-4 py-3 text-right font-medium">{labels.colEtage}</th>
              <th className="px-4 py-3 text-right font-medium">{labels.colFull}</th>
            </tr>
          </thead>
          <tbody>
            {rows.map((row, i) => (
              <tr key={i} className={i % 2 ? "bg-sable/40" : "bg-white"}>
                <td className="px-4 py-3.5 font-medium text-anthracite">{row.season}</td>
                <td className="px-4 py-3.5 text-anthracite/70">{row.period}</td>
                <td className="px-4 py-3.5 text-right text-anthracite/80">{row.priceRdc}</td>
                <td className="px-4 py-3.5 text-right text-anthracite/80">{row.priceEtage}</td>
